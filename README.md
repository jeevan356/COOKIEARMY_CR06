...
- test code
- visualization code
(https://ai.facebook.com/blog/facebook-research-at-cvpr-2020/) to learn more about our work at CVPR2020!
...
After This first Step we are going to Integrate with the Website with tensorflow.js
then we develop an android app (reminder don't forget to import libraries before extract the app or else all it will throw an error)
after all we created a unqiue level Hologram of the model which we got in 3d avatar
