        ...
        if (!isInternalUri(uri)) {
            ...
            if (mode.equals(RegexRulesManager.MODE_APP_BROWSER)) {
                CustomTabColorSchemeParams params = new CustomTabColorSchemeParams.Builder()
                        .setToolbarColor(ContextCompat.getColor(mainActivity, R.color.colorPrimary))
                        .setSecondaryToolbarColor(ContextCompat.getColor(mainActivity, R.color.titleTextColor))
                        .build();
            ...
            if (getCurrentWebviewUrl() == null) mainActivity.loadUrl(appConfig.getInitialUrl());
            return true;
        }
